...
RUN chown -R cloudron:cloudron /app/code && \
    ...
    gosu cloudron:cloudron npm install --legacy-peer-deps \
        ...
        @rmdes/indiekit-endpoint-lastfm@1.0.11 \
        @rmdes/indiekit-endpoint-youtube@1.2.3 \
        @rmdes/indiekit-endpoint-rss@1.0.12 \
        @rmdes/indiekit-endpoint-microsub@1.0.29 \
        @rmdes/indiekit-syndicator-indienews@1.0.1 \
        @rmdes/indiekit-endpoint-podroll@1.0.10 \
        @rmdes/indiekit-endpoint-webmention-sender@1.0.5 \
